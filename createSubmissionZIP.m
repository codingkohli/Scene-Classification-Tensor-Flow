...
%
% It is odd to use this for a python project...
% Please volunteer to TA for next year, and fix it : )
...
% writeupFile = ['writeup' filesep '*.pdf'];
% if ~exist(writeupFile,'file')
%     cd 'writeup'
%     command1 = 'pdflatex *.tex';
%     command2 = 'bibtex';
...
zip( '1430submission.zip', {'code/*.py','writeup/*.pdf'} );
